...
import Dropzone, { ChildArgs, PossibleDroppableObject } from "../../ui-components/Dropzone";
...
const DropzoneBetweenElements = <DroppableObject extends PossibleDroppableObject> ({onDrop, children, acceptedDropTypes}: PropsT<DroppableObject>) => {
