    ...
    <button
      className={classnames(
        ...
        `previous-queries-filter-button--${props.value}`, {
          'previous-queries-filter-button--selected': props.selectedFilter === props.value
        }
      )}
...
export default connect(mapStateToProps, mapDispatchToProps)(PreviousQueriesFilterButton);
