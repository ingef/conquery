...
4. To install cypress and it's dependencies, run `pnpm install` from an other terminal in the `conquery/` folder
5. Then run `pnpm exec cypress open` to start cypress
