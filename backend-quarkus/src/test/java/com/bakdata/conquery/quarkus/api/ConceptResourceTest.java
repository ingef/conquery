...
class ConceptResourceTest {
	...
	void conceptEndpointReturnsConceptMap() {
		given()
				...
				.body("imdb.selects[0].id", equalTo("imdb.exists"))
				.body("imdb.selects[0].label", equalTo("Exists"))
				.body("imdb.selects[0].default", equalTo(true))
				.body("imdb.selects[0].resultType.type", equalTo("BOOLEAN"))
