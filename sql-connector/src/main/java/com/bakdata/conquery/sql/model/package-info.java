 ...
 * describe query semantics and physical database objects, but deliberately exclude dataset routing, datasource
 * selection, connections, dialects, and SQL compiler state.</p>
 *
