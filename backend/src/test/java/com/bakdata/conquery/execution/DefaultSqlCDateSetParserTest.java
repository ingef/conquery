...
class DefaultSqlCDateSetParserTest {
	...
	public static Stream<Arguments> testToEpochDayRangeListProvider() {
		return Stream.of(
				...
				Arguments.of("{[-∞,∞]}", "{-inf/+inf}", "Infinity datemultirange"),
				Arguments.of("{[2012-01-01,2013-01-01)}", "{2012-01-01/2012-12-31}", "datemultirange with 1 daterange"),
				Arguments.of("{[-∞,2013-01-01),[2015-01-01,∞]}", "{-inf/2012-12-31,2015-01-01/+inf}", "datemultirange with multiple ranges and infinity start and end value"),
