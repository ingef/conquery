...
class DefaultSqlCDateSetParserTest {
	...
	private static final SqlCDateSetParser DATE_SET_PARSER = new PgSqlCDateSetParser();
	...
	public static Stream<Arguments> testToEpochDayRangeListProvider() {
		return Stream.of(
				Arguments.of("empty", "{}", "Empty datemultirange"),
				Arguments.of("{[-infinity,infinity]}", "{/}", "Infinity datemultirange"),
				Arguments.of("{[2012-01-01,2013-01-01)}", "{2012-01-01/2012-12-31}", "datemultirange with 1 daterange"),
				Arguments.of("{[-infinity,2013-01-01),[2015-01-01,infinity]}", "{/2012-12-31,2015-01-01/}", "datemultirange with multiple ranges and infinity start and end value"),
