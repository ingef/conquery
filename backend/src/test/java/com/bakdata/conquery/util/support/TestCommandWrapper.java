...
// see #169 this is a workaround for
// https://github.com/dropwizard/dropwizard/issues/2496
	...
	public void run(Bootstrap bootstrap, Namespace namespace) throws Exception {
		bootstrap
			.setConfigurationFactoryFactory(
				(klass, validator, objectMapper, propertyPrefix) -> new POJOConfigurationFactory<ConqueryConfig>(config));
