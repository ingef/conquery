...
public class TernaryTreeBalancerTest {
	...
	public void valid(long seed) {
		...
		assertThat((Predicate<ABytesNode>) TernaryTreeTestUtil::isBalanced).rejects(bytesTTMap.getRoot());

		bytesTTMap.balance();

		assertThat((Predicate<ABytesNode>) TernaryTreeTestUtil::isBalanced).accepts(bytesTTMap.getRoot());
