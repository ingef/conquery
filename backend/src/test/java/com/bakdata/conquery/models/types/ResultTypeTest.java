...
//TODO Arguments.of(PRETTY_DE, ConqueryConstants.formResolutionInfo(PLAIN), Resolution.COMPLETE.name(), "Gesamt"),
				...
				Arguments.of(PRETTY, ResultType.Primitive.DATE_RANGE, List.of(Long.valueOf(LocalDate.of(2013, 7, 12).toEpochDay())
																						.intValue(), Long.valueOf(LocalDate.of(2013, 7, 12).toEpochDay())
																										 .intValue()), "2013-07-12"),
				Arguments.of(PRETTY_DE, ResultType.Primitive.DATE_RANGE, List.of(Long.valueOf(LocalDate.of(2013, 7, 12).toEpochDay())
																						   .intValue(), Long.valueOf(LocalDate.of(2013, 7, 12).toEpochDay())
																											.intValue()), "12.07.2013"),
				Arguments.of(PRETTY, ResultType.Primitive.DATE_RANGE, List.of(Long.valueOf(LocalDate.of(2013, 7, 12).toEpochDay())
																						.intValue(), Long.valueOf(LocalDate.of(2014, 7, 12).toEpochDay())
																										 .intValue()), "2013-07-12/2014-07-12"),
				Arguments.of(PRETTY_DE, ResultType.Primitive.DATE_RANGE, List.of(Long.valueOf(LocalDate.of(2013, 7, 12).toEpochDay())
																						   .intValue(), Long.valueOf(LocalDate.of(2014, 7, 12).toEpochDay())
																											.intValue()), "12.07.2013 - 12.07.2014"),
				...
				Arguments.of(PLAIN, ResultType.Primitive.STRING, "test", "test"),
				Arguments.of(PLAIN, ResultType.Primitive.STRING, Resolution.COMPLETE.name(), "COMPLETE"), // TODO fk: is supposed not to test the mapping?
