...
public class ResultTypeTest {
	...
	private static final PrintSettings PRETTY = new PrintSettings(true, Locale.ENGLISH, CONFIG, null, null);
	private static final PrintSettings PRETTY_DE = new PrintSettings(true, Locale.GERMANY, CONFIG, null, null);
	private static final PrintSettings PLAIN = new PrintSettings(false, Locale.ENGLISH, CONFIG, null, null);
