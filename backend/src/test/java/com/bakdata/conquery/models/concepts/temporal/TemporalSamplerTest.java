...
class TemporalSamplerTest {
	...
	public void earliest() {
		...
		assertThat(EARLIEST.sample(generateSet(exactly(LocalDate.of(2011, 1, 10))))).hasValue(ofLocalDate(LocalDate.of(2011, 1, 10)));

		assertThat(EARLIEST.sample(generateSet(atLeast(LocalDate.of(2011, 1, 10))))).hasValue(ofLocalDate(LocalDate.of(2011, 1, 10)));

		assertThat(EARLIEST.sample(generateSet(atMost(LocalDate.of(2011, 1, 10))))).isEmpty();
	...
	public void latest() {
		...
		assertThat(LATEST.sample(generateSet(exactly(LocalDate.of(2011, 1, 10))))).hasValue(ofLocalDate(LocalDate.of(2011, 1, 10)));

		assertThat(LATEST.sample(generateSet(atLeast(LocalDate.of(2011, 1, 10))))).isEmpty();

		assertThat(LATEST.sample(generateSet(atMost(LocalDate.of(2011, 1, 10))))).hasValue(ofLocalDate(LocalDate.of(2011, 1, 10)));
	...
	@Test
	public void random() {
		assertThat(RANDOM.sample(generateSet(exactly(LocalDate.of(2011, 1, 10))))).hasValue(ofLocalDate(LocalDate.of(2011, 1, 10)));

		{
			CDateSet set = generateSet(of(LocalDate.of(2011, 1, 10), LocalDate.of(2011, 1, 12)));

			assertThat(RANDOM.sample(set).getAsInt()).matches(set::contains);
		}

		{
			CDateSet set = generateSet(
