...
class RangeTest {
	...
	public void atMost() {
		...
		assertThat((IntPredicate) range::contains).accepts(5, 4, Integer.MIN_VALUE).rejects(6, Integer.MAX_VALUE);
	...
	public void atLeast() {
		...
		assertThat((IntPredicate) range::contains).accepts(5, 6, Integer.MAX_VALUE).rejects(4, Integer.MIN_VALUE);
	...
	public void all() {
		...
		assertThat((IntPredicate) range::contains).accepts(5, Integer.MAX_VALUE, Integer.MIN_VALUE);
	...
	public void contains() {
		...
		assertThat((IntPredicate) range::contains).accepts(5, 6, 7, 8, 9, 10).rejects(Integer.MIN_VALUE, 4, 11, Integer.MAX_VALUE);
	...
	@Test
	public void span() {
		assertThat(Range.exactly(5).span(Range.exactly(6))).isEqualTo(Range.of(5, 6)).isEqualTo(Range.exactly(6).span(Range.exactly(5)));
	...
	public void deserialize(String json, Range<LocalDate> expected, CDateRange expectedCDateRange) throws IOException {
		ObjectReader reader = Jackson.MAPPER
			.readerFor(Jackson.MAPPER.getTypeFactory().constructParametricType(Range.class, LocalDate.class));
