...
public class IntrospectionDelegatingRealmTest {
	...
	private static final Group GROUP_1_EXISTING = new Group(GROUPNAME_1, GROUPNAME_1, STORAGE::updateGroup);
	...
	public void tokenIntrospectionSimpleUserNew() {
		...
		assertThat(STORAGE.getAllUsers()).containsOnly(new User(USER_1_NAME, USER_1_NAME, STORAGE::updateUser));
	}
	
	@Test
	public void tokenIntrospectionSimpleUserExisting() {
		User existingUser = new User(USER_1_NAME, USER_1_NAME, STORAGE::updateUser);
	...
	public void tokenIntrospectionGroupedUser() {
		...
		assertThat(STORAGE.getAllUsers()).containsOnly(new User(USER_2_NAME, USER_2_LABEL, STORAGE::updateUser));
	...
	public void tokenIntrospectionGroupedUserRemoveGroupMapping() {
		User user = new User(USER_3_NAME, USER_3_LABEL, STORAGE::updateUser);
		...
		assertThat(STORAGE.getAllUsers()).containsOnly(new User(USER_3_NAME, USER_3_LABEL, STORAGE::updateUser));
