...
public class IdpConfigRetrievalTest {
	...
	private static final MockServerExtension OIDC_SERVER = new MockServerExtension(
		...
		IdpConfigRetrievalTest::init);

	private static final JwtPkceVerifyingRealmFactory REALM_FACTORY = new JwtPkceVerifyingRealmFactory();

	private static final Client CLIENT = new JerseyClientBuilder(new Environment("oidc-test")).build(
		"oidc-test-client");
