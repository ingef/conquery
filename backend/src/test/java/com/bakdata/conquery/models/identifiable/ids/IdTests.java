...
public class IdTests {
	...
	public static Stream<Arguments> reflectionTest() {
		return CPSTypeIdResolver.SCAN_RESULT
			.getClassesImplementing(Identifiable.class.getName())
			.loadClasses()
			.stream()
			...
			.map(cl -> {
				...
				while (idClass == null && current != null) {
					...
					try {
						return Arguments.of(cl, Class.forName("com.bakdata.conquery.models.identifiable.ids.specific." + name + "Id"));
					}
