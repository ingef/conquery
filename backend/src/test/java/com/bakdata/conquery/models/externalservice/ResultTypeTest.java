...
public class ResultTypeTest {
	...
	public static Stream<Arguments> testData() {
		...
		return Stream.of(
			...
			Arguments.of(PRETTY, ResultType.DateT.INSTANCE, LocalDate.of(2013, 07, 12), "2013-07-12"),
			...
			Arguments.of(PLAIN, ResultType.DateT.INSTANCE, LocalDate.of(2013, 07, 12), "2013-07-12"),
