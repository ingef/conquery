...
public class ResultTypeTest {
	...
	public static List<Arguments> testData() {
		return List.of(
			...
			Arguments.of(PRETTY, new ResultType.StringLocalizedT(new Resolution.LocalizationProvider()), Resolution.COMPLETE.name(), "complete"),
			Arguments.of(PRETTY_DE, new ResultType.StringLocalizedT(new Resolution.LocalizationProvider()), Resolution.COMPLETE.name(), "Gesamt"),
