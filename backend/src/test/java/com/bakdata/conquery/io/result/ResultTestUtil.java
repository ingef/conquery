...
public class ResultTestUtil {
	...
	public static List<EntityResult> getTestEntityResults() {
		List<EntityResult> results = List.of(
				...
				new SinglelineEntityResult(2, new Object[]{Boolean.FALSE, null, null, null, null, null, null, null, null, List.of(), List.of(List.of(LocalDate.of(1999,12,31).toEpochDay(), Integer.MAX_VALUE)), List.of()}),
