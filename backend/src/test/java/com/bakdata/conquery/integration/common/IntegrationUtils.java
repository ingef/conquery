...
public class IntegrationUtils {
	...
	/**
	 * Load the constellation of roles, users and permissions into the provided
	 * storage.
	 */
	public static void importPermissionConstellation(MasterMetaStorage storage, Mandator[] roles, RequiredUser[] rUsers, ConqueryPermission[] permissions) throws JSONException {
