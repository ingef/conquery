...
public class QueryStatisticsTest implements ProgrammaticIntegrationTest {
	...
	public void execute(String name, TestConquery testConquery) throws Exception {
		...
		final String testJson = LoadingUtil.readResource(
			"/tests/query/QUERY_STATISTICS_TESTS/SIMPLE_TREECONCEPT_Query.json");
		...
		final UriBuilder uriBuilder = HierarchyHelper.hierarchicalPath(
			conquery.defaultApiURIBuilder(),
			QueryResource.class,
			"getDescription");

		final ResultStatistics results = conquery.getClient()
			.target(
