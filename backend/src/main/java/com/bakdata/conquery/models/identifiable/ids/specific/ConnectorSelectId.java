...
public class ConnectorSelectId extends SelectId {
	...
	@Override
	public Select get() {
		return getStorage().getConcept(findConcept()).getConnectorByName(getConnector().getConnector()).getSelectByName(getSelect());
	}
