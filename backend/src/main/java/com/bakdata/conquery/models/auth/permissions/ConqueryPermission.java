...
public abstract class ConqueryPermission extends IdentifiableImpl<PermissionId> implements Permission, HasTarget {
	...
	/**
	 * Reduces a list of permissions, by combining permissions of the same owner and
	 * target by merging the access types of the individual permissions into one
	 * enum.
	 */
	...
	/**
	 * Returns a new permission with the owner swapped. This is useful, when the
	 * permissions of roles of a user need to be checked. The user object knows the
	 * impersonated roles and swaps the owner accordingly.
	 */
