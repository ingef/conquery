...
public class FirstValueMappedSelect extends FirstValueSelect implements SingleValueMappedSelect {

	@JsonIgnore
	private final InternToExternMapping mapping;

	public FirstValueMappedSelect(@NsIdRef Column column, @JacksonInject InternToExternMapping mapping) {
		super(column);
