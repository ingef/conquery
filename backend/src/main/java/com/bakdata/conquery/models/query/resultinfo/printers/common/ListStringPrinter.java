...
public record ListStringPrinter<T>(Printer<T> elementPrinter, PrintSettings cfg, LocaleConfig.ListFormat listFormat) implements Printer<List<T>> {
	...
	@Override
	public String apply(@NotNull List<T> f) {
