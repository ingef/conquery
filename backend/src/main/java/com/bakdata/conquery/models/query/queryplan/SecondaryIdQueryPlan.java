 ...
 * one result per distinct value in a {@link SecondaryIdId} Column.
 *
 * @implNote This class will first execute the Query on all Tables carrying the selected {@link SecondaryIdId}. Which will then be joined with all Tables that don't have a {@link SecondaryIdId}, or are explicitly excluded (via {@link com.bakdata.conquery.models.query.concept.specific.CQConcept#excludeFromSecondaryIdQuery}.
 *
