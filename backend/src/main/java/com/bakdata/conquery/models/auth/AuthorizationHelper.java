...
public class AuthorizationHelper {
	 ...
	 * 
	 * @param user
	 *            The subject that needs authorization.
	 * @param dataset
	 *            The id of the object that needs to be checked.
	 * @param ability
	 *            The kind of ability that is checked.
	 */
	 ...
	 * 
	 * @param owner
	 *            The subject to own the new permission.
	 * @param permission
	 ...
	 * @param storage
	 *            A storage where the permission is removed from.
	 * @throws JSONException
	 *             When the permission object could not be formed in to the
	 *             appropriate JSON format.
	 */
