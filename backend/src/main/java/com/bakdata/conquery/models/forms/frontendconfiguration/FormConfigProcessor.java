...
public class FormConfigProcessor {
	 ...
	 **/
	public Stream<FormConfigOverviewRepresentation> getConfigsByFormType(@NonNull Userish user, Dataset dataset, @NonNull Set<String> requestedFormType) {
	 ...
	 */
	public FormConfigFullRepresentation getConfig(Userish user, FormConfig form) {
	 ...
	 * @return
	 */
	public FormConfig addConfig(Userish user, Dataset targetDataset, FormConfigAPI config) {
	 ...
	 * @return
	 */
	public FormConfig addConfigAndTranslations(Userish user, Dataset targetDataset, FormConfigAPI config) {
	 ...
	 */
	public FormConfigFullRepresentation patchConfig(Userish user, FormConfig config, FormConfigPatch patch) {
	 ...
	 */
	public void deleteConfig(Userish userish, FormConfig config) {
		User user = storage.getUser(userish.getId());
