...
/**
 * This interface represents the basic modules that conquery's authentication
 * and authorization system needs.
 */
...
public abstract class AuthConfig {
	 ...
	 * 
	 * @param storage
	 *            (Unused) A storage from which a realm can query information about
	...
	/**
	 * Gets an extractor that parse a token from a request. The token is then used
