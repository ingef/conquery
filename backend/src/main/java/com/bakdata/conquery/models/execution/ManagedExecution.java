...
public abstract class ManagedExecution<R extends ShardResult> extends IdentifiableImpl<ManagedExecutionId> implements Taggable, Shareable, Labelable, Owned, Visitable {
	...
	protected void setStatusBase(@NonNull Subject user, @NonNull ExecutionStatus status) {
	 ...
	 */
	public OverviewExecutionStatus buildStatusOverview(UriBuilder url, Subject user) {
	 ...
	 */
	public FullExecutionStatus buildStatusFull(@NonNull MetaStorage storage, Subject user, DatasetRegistry datasetRegistry, ConqueryConfig config) {
	 ...
	 */
	protected void setAdditionalFieldsForStatusWithSource(Subject user, FullExecutionStatus status) {
