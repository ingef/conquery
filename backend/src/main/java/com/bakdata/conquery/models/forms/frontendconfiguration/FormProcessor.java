...
public class FormProcessor {
	...
	/**
	 * Frontend Form configurations can be provided from different sources. For these sources a stub of type {@link FormFrontendConfigProviderBase} must be implemented
	 * in order to be discovered by this function.
	 */
	@SneakyThrows
	private static List<FormFrontendConfigInformation> findFrontendFormConfigs() {
		List<Class<?>> configProviders = CPSTypeIdResolver.SCAN_RESULT.getClassesImplementing(FormFrontendConfigProvider.class.getName()).loadClasses();
