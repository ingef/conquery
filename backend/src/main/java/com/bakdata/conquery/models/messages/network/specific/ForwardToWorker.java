...
public class ForwardToWorker extends MessageToShardNode implements SlowMessage {
	...
	public static ForwardToWorker create(DatasetId datasetId, WorkerMessage message, ObjectWriter writer) {
	...
	public void react(ShardNodeNetworkContext context) throws Exception {
		final Worker worker = Objects.requireNonNull(context.getWorkers().getWorker(datasetId));
