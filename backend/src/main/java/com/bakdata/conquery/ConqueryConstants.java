...
public class ConqueryConstants {
	...
	public static final ResultInfo DATE_RANGE_INFO = new LocalizedSimpleResultInfo((l) -> C10N.get(ResultHeadersC10n.class, l).dateRange(), ResultType.DateRangeT.INSTANCE);
	...
	public static final ResultInfo FEATURE_DATE_RANGE_INFO = new LocalizedSimpleResultInfo((l) -> C10N.get(ResultHeadersC10n.class, l).featureDateRange(), ResultType.DateRangeT.INSTANCE);
	public static final ResultInfo OUTCOME_DATE_RANGE_INFO = new LocalizedSimpleResultInfo((l) -> C10N.get(ResultHeadersC10n.class, l).outcomeDateRange(), ResultType.DateRangeT.INSTANCE);
