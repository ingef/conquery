...
public class ConqueryConstants {
	...
	public static final ResultInfo CONTEXT_INDEX_INFO = new LocalizedDefaultResultInfo(null, (l) -> C10N.get(ResultHeadersC10n.class, l).index(), ResultType.IntegerT.INSTANCE);
	public static final ResultInfo DATE_RANGE_INFO = new LocalizedDefaultResultInfo(null, (l) -> C10N.get(ResultHeadersC10n.class, l).dateRange(), ResultType.DateRangeT.INSTANCE);
	public static final ResultInfo RESOLUTION_INFO = new LocalizedDefaultResultInfo(null, (l) -> C10N.get(ResultHeadersC10n.class, l).resolution(), ResultType.ResolutionT.INSTANCE);
	public static final ResultInfo EVENT_DATE_INFO = new LocalizedDefaultResultInfo(null, (l) -> C10N.get(ResultHeadersC10n.class, l).eventDate(), ResultType.DateT.INSTANCE);
	public static final ResultInfo FEATURE_DATE_RANGE_INFO = new LocalizedDefaultResultInfo(null, (l) -> C10N.get(ResultHeadersC10n.class, l).featureDateRange(), ResultType.DateRangeT.INSTANCE);
	public static final ResultInfo OUTCOME_DATE_RANGE_INFO = new LocalizedDefaultResultInfo(null, (l) -> C10N.get(ResultHeadersC10n.class, l).outcomeDateRange(), ResultType.DateRangeT.INSTANCE);
