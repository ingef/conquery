...
public class FormConstants {
	 ...
	 */
	public static Field<Date> INDEX_START_NEGATIVE = DSL.field(
		DSL.name(SharedAliases.INDEX_START_NEGATIVE.getAlias()),
		Date.class);

	/**
	 * The index date from which we start when calculating an outcome range.
	 */
	public static Field<Date> INDEX_START_POSITIVE = DSL.field(
		DSL.name(SharedAliases.INDEX_START_POSITIVE.getAlias()),
		Date.class);
	 ...
	 */
	public static Field<Date> YEAR_END_QUARTER_ALIGNED = DSL.field(
		DSL.name(SharedAliases.YEAR_END_QUARTER_ALIGNED.getAlias()),
		Date.class);

	/**
	 * The amount times an interval added to a date, aligned on a year.
	 */
	public static Field<Integer> YEAR_ALIGNED_COUNT = DSL.field(
		DSL.name(SharedAliases.YEAR_ALIGNED_COUNT.getAlias()),
		Integer.class);

	/**
	 * The amount times an interval added to a date, aligned on a quarter.
	 */
	public static Field<Integer> QUARTER_ALIGNED_COUNT = DSL.field(
		DSL.name(SharedAliases.QUARTER_ALIGNED_COUNT.getAlias()),
		Integer.class);

	/**
	 * The amount times an interval added to a date, aligned a day.
	 */
	public static Field<Integer> DAY_ALIGNED_COUNT = DSL.field(
		DSL.name(SharedAliases.DAY_ALIGNED_COUNT.getAlias()),
		Integer.class);

	/**
	 * The int field generated by a generate_series SQL set-returning function.
	 */
	public static Field<Integer> SERIES_INDEX = DSL.field(
		DSL.name(SharedAliases.SERIES_INDEX.getAlias()),
		Integer.class);
