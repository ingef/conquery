...
public interface SelectConverter<S extends Select> {
	...
	default ConnectorSqlSelects connectorSelect(S select, SelectContext<Connector, ConnectorSqlTables> selectContext) {
	...
	default ConceptSqlSelects conceptSelect(S select, SelectContext<TreeConcept, ConceptSqlTables> selectContext) {
