...
public interface Converter<C, R, X extends Context> {
	 ...
	 *
	 * @return PREPROCESSING, AGGREGATION_SELECT and FINAL {@link ConceptStep} as defaults. Override if more steps are required.
	 */
	default Set<ConceptStep> requiredSteps() {
		return ConceptStep.MANDATORY_STEPS;
	}
