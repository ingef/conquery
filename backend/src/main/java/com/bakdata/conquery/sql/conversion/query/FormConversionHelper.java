...
public class FormConversionHelper {
    ...
    private static Selects getFinalSelects(
        ...
        ColumnDateRange columnDateRange = stratificationSelects.getStratificationDate()
                .get().as(SharedAliases.STRATIFICATION_BOUNDS.getAlias());

        Selects.SelectsBuilder selects = Selects.builder()
                .ids(ids)
                .validityDate(Optional.empty())
                .stratificationDate(Optional.of((columnDateRange)));
