...
public class ProgressReporterUtil {
	...
	private final static DateTimeFormatter TIME_FORMATTER = new DateTimeFormatterBuilder().appendValue(
	...
	/* package */ String buildProgressReportString(
		boolean done,
		long progress,
		long maxProgress,
		long elapsedMillis,
		...
		long estimateMillis = DoubleMath.roundToLong(
			(elapsedMillis / progress) * remainingProgress,
