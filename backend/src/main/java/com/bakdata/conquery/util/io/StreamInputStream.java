 ...
 * For example, you could stream a JDBC recordset record by record from a DB query, transform them and write them to this stream one at a time without loading the whole recordset into memory.
