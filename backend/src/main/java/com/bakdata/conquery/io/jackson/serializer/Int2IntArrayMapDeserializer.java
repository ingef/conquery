...
public class Int2IntArrayMapDeserializer extends StdDeserializer<Int2IntArrayMap> {
	...
	@Override
	public Int2IntArrayMap deserialize(
		JsonParser p,
		DeserializationContext ctxt) throws IOException {
		final Int2IntMapSerializer.SerializationContainer container = p.readValueAs(
			Int2IntMapSerializer.SerializationContainer.class);
