...
public class ResultCsvProcessor {
	...
	public <E extends ManagedExecution<?> & SingleTableResult> Response getResult(Subject user, Dataset dataset, E exec, String userAgent, String queryCharset, boolean pretty) {
