...
public interface MasterMetaStorage extends ConqueryStorage {
	 ...
	 *             Is throw on a JSON related failure.
	 */
	 ...
	 * 
	 * @param id
	 *            The id of the permission that will be deleted.
	 */
	 ...
	 * 
	 * @param id
	 *            The id of the permission to be retrieved.
	 ...
	 * 
	 * @param user
	 *            The user, which holds the values, to be updated.
	 * @throws JSONException
	 *             Is throw on a JSON related failure.
	 */
	 ...
	 * 
	 * @param id
	 *            The id of the mandator to be retrieved.
	 ...
	 * 
	 * @param id
	 *            The id of the mandator that will be deleted.
	 */
	 ...
	 * 
	 * @param mandator
	 *            The mandator, which holds the values, to be updated.
	 * @throws JSONException
	 *             Is throw on a JSON related failure.
	 */
