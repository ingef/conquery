...
<#macro deleteButton id contentPath testId="">
	 <a href="" onclick="event.preventDefault(); rest('/admin/datasets/${c.ds.id}/${contentPath}/${id}',{method: 'delete'}).then(function(res){if(res.ok)location.reload();});" data-test-id="${testId}">
